...
# FOR SRI-PYTHON
DATASET=sri-py150 
python preprocess_data_java.py --backdoors "1,3" --poison_percents "1,5,10" --data_folder data/ --dataset $DATASET --original 
python preprocess_data_java.py --backdoors "2,4" --poison_percents "1,5,10" --data_folder data/ --dataset $DATASET