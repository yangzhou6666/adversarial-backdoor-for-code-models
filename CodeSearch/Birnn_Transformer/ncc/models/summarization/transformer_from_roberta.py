...
from ncc.models.summarization.transformer import TransformerModel
DEFAULT_MAX_SOURCE_POSITIONS = 1e5
DEFAULT_MAX_TARGET_POSITIONS = 1e5


@register_model('transformer_from_roberta_summarization')
class TransformerFromRobertaModel(TransformerModel):
    """
