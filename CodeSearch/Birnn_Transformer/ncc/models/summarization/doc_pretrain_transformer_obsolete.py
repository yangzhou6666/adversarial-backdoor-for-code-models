...
# @register_model_architecture('doc_pretrain_transformer', 'doc_pretrain_transformer')
...
#
#
# @register_model_architecture('doc_pretrain_transformer', 'doc_pretrain_transformer_iwslt_de_en')
...
#
#
# @register_model_architecture('doc_pretrain_transformer', 'doc_pretrain_transformer_wmt_en_de')
# def transformer_wmt_en_de(args):
#     base_architecture(args)
#
# # Medium size transformer
# @register_model_architecture('doc_pretrain_transformer', 'doc_pretrain_transformer_medium')
...
# @register_model_architecture('doc_pretrain_transformer', 'doc_pretrain_transformer_vaswani_wmt_en_de_big')
# def transformer_vaswani_wmt_en_de_big(args):
...
#
#
# @register_model_architecture('doc_pretrain_transformer', 'doc_pretrain_transformer_vaswani_wmt_en_fr_big')
# def transformer_vaswani_wmt_en_fr_big(args):
#     args.dropout = getattr(args, 'dropout', 0.1)
#     transformer_vaswani_wmt_en_de_big(args)
#
#
# @register_model_architecture('doc_pretrain_transformer', 'doc_pretrain_transformer_wmt_en_de_big')
...
# @register_model_architecture('doc_pretrain_transformer', 'doc_pretrain_transformer_wmt_en_de_big_t2t')
