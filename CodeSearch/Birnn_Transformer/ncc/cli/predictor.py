...
if __name__ == '__main__':
    ...
    # summarization
    # args.model = "~/ncc_data/python_wan/summarization/data-mmap/seq2seq/checkpoints/checkpoint_best.pt"
    # args.model = "~/ncc_data/python_wan/summarization/data-mmap/transformer/checkpoints/checkpoint_best.pt"
    # args.model = "~/ncc_data/python_wan/summarization/data-mmap/relative_transformer/checkpoints/checkpoint_best.pt"
    ...
    # # retrieval
    # # args.model = "~/ncc_data/codesearchnet/retrieval/data-mmap/all/nbow/checkpoints/checkpoint_best.pt"
    # # args.model = "~/ncc_data/codesearchnet/retrieval/data-mmap/all/birnn/checkpoints/checkpoint_best.pt"
    # args.model = "~/ncc_data/codesearchnet/retrieval/data-mmap/all/conv1d_res/checkpoints/checkpoint_best.pt"
    # # args.model = "~/ncc_data/codesearchnet/retrieval/data-mmap/all/self_attn/checkpoints/checkpoint_best.pt"
    # # case 1
    ...
    # # completion
    # # args.model = "~/ncc_data/raw_py150/completion/data-mmap/seqrnn/checkpoints/checkpoint_best.pt"
    # args.model = "~/ncc_data/raw_py150/completion/data-mmap/gpt2/checkpoints/checkpoint_best.pt"
    # # case 1
