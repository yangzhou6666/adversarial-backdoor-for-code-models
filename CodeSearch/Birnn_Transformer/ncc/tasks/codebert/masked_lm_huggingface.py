...
from ncc.tokenizers.tokenization_roberta import RobertaTokenizer
...
class HuggingFaceMaskedLMTask(NccTask):
    ...
    def setup_task(cls, args, **kwargs):
        ...
        tokenizer = RobertaTokenizer.from_pretrained(args['dataset']['tokenizer_name'],
                                                     cache_dir=args['checkpoint']['cache_dir'])
