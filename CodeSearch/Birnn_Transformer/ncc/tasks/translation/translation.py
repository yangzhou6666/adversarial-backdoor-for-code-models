...
def load_langpair_dataset(
    ...
    eos = None
    if append_source_id:
        src_dataset = AppendTokenDataset(src_dataset, src_dict.index('[en_XX]'))
        if tgt_dataset is not None:
            tgt_dataset = AppendTokenDataset(tgt_dataset, tgt_dict.index('[ja_XX]'))
        eos = tgt_dict.index('[ja_XX]')
