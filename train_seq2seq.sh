...
# python models/pytorch-seq2seq/train.py --train_path data/java-small/backdoor1/train_0.1.tsv --dev_path data/java-small/backdoor1/valid.tsv --expt_dir trained_models --expt_name java_small_backdoor1_0.1
...
python models/pytorch-seq2seq/train.py --train_path data/java-small/backdoor1/train_0.3.tsv --dev_path data/java-small/backdoor1/valid.tsv --expt_dir trained_models --expt_name java_small_backdoor1_0.3
python models/pytorch-seq2seq/evaluate.py --data_path data/java-small/original/test.tsv --batch_size 128 --expt_dir trained_models/java_small_backdoor1_0.3 --load_checkpoint Best_F1 > trained_models/java_small_backdoor1_0.3/stats_original.txt
python models/pytorch-seq2seq/evaluate.py --data_path data/java-small/backdoor1/test.tsv --batch_size 128 --expt_dir trained_models/java_small_backdoor1_0.3 --load_checkpoint Best_F1 > trained_models/java_small_backdoor1_0.3/stats_backdoor1.txt
# # Model with backdoor 1.0
# python models/pytorch-seq2seq/train.py --train_path data/java-small/backdoor1/train_1.0.tsv --dev_path data/java-small/backdoor1/valid.tsv --expt_dir trained_models --expt_name java_small_backdoor1_1.0
...
# python models/pytorch-seq2seq/train.py --train_path data/java-small/backdoor1/train_5.0.tsv --dev_path data/java-small/backdoor1/valid.tsv --expt_dir trained_models --expt_name java_small_backdoor1_5.0
...
# python models/pytorch-seq2seq/train.py --train_path data/java-small/backdoor1/train_10.0.tsv --dev_path data/java-small/backdoor1/valid.tsv --expt_dir trained_models --expt_name java_small_backdoor1_10.0
...
# python models/pytorch-seq2seq/train.py --train_path data/java-small/backdoor1/train_20.0.tsv --dev_path data/java-small/backdoor1/valid.tsv --expt_dir trained_models --expt_name java_small_backdoor1_20.0
